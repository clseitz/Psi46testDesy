...
{
  RPC_PROFILING uint16_t rpc_par0;
  try {
    uint16_t rpc_clientCallId = rpc_GetCallId( 0 );
    RPC_THREAD_LOCK rpcMessage msg;
  ...
  RPC_THREAD_UNLOCK} catch( CRpcError & e ) {
    e.SetFunction( 0 );
    throw;
  };
  return rpc_par0;
...
{
  RPC_PROFILING int32_t rpc_par0;
  try {
...
{
  RPC_PROFILING uint32_t rpc_par0;
  try {
...
{
  RPC_PROFILING uint8_t rpc_par0;
  try {
...
void CTestboard::SetClockStretch( uint8_t rpc_par1, uint16_t rpc_par2,
                                  uint16_t rpc_par3 )
{
  RPC_PROFILING try {
...
void CTestboard::Sig_SetDelay( uint8_t rpc_par1, uint16_t rpc_par2,
                               int8_t rpc_par3 )
{
  RPC_PROFILING try {
...
uint8_t CTestboard::Daq_Read( HWvectorR < uint16_t > &rpc_par1,
                              uint32_t rpc_par2, uint8_t rpc_par3 )
{
  RPC_PROFILING uint8_t rpc_par0;
  try {
...
uint8_t CTestboard::Daq_Read( HWvectorR < uint16_t > &rpc_par1,
                              uint32_t rpc_par2, uint32_t & rpc_par3,
                              uint8_t rpc_par4 )
{
  RPC_PROFILING uint8_t rpc_par0;
  try {
...
void CTestboard::Daq_Select_ADC( uint16_t rpc_par1, uint8_t rpc_par2,
                                 uint8_t rpc_par3, uint8_t rpc_par4 )
{
  RPC_PROFILING try {
...
void CTestboard::roc_Pix( uint8_t rpc_par1, uint8_t rpc_par2,
                          uint8_t rpc_par3 )
{
  RPC_PROFILING try {
...
void CTestboard::roc_Pix_Trim( uint8_t rpc_par1, uint8_t rpc_par2,
                               uint8_t rpc_par3 )
{
  RPC_PROFILING try {
...
void CTestboard::roc_Pix_Cal( uint8_t rpc_par1, uint8_t rpc_par2,
                              bool rpc_par3 )
{
  RPC_PROFILING try {
...
int32_t CTestboard::PH( int32_t rpc_par1, int32_t rpc_par2, int32_t rpc_par3,
                        int16_t rpc_par4 )
{
  RPC_PROFILING int32_t rpc_par0;
  try {
...
int32_t CTestboard::PixelThreshold( int32_t rpc_par1, int32_t rpc_par2,
                                    int32_t rpc_par3, int32_t rpc_par4,
                                    int32_t rpc_par5, int32_t rpc_par6,
                                    int32_t rpc_par7, bool rpc_par8,
                                    bool rpc_par9 )
{
  RPC_PROFILING int32_t rpc_par0;
  try {
...
int8_t CTestboard::CalibratePixel( int16_t rpc_par1, int16_t rpc_par2,
                                   int16_t rpc_par3, int16_t & rpc_par4,
                                   int32_t & rpc_par5 )
{
  RPC_PROFILING int8_t rpc_par0;
  try {
...
int8_t CTestboard::CalibrateDacScan( int16_t rpc_par1, int16_t rpc_par2,
                                     int16_t rpc_par3, int16_t rpc_par4,
                                     int16_t rpc_par5, int16_t rpc_par6,
...
int8_t CTestboard::CalibrateDacDacScan( int16_t rpc_par1, int16_t rpc_par2,
                                        int16_t rpc_par3, int16_t rpc_par4,
                                        int16_t rpc_par5, int16_t rpc_par6,
                                        int16_t rpc_par7, int16_t rpc_par8,
                                        int16_t rpc_par9,
...
{
  RPC_PROFILING int16_t rpc_par0;
  try {
...
int16_t CTestboard::CalibrateMap( int16_t rpc_par1,
...
int16_t CTestboard::TriggerRow( int16_t rpc_par1, int16_t rpc_par2,
                                vector < int16_t > &rpc_par3,
                                int16_t rpc_par4 )
{
  RPC_PROFILING int16_t rpc_par0;
  try {
...
bool CTestboard::TestColPixel( uint8_t rpc_par1, uint8_t rpc_par2,
                               bool rpc_par3, vectorR < uint8_t > &rpc_par4 )
{
  RPC_PROFILING bool rpc_par0;
  try {
...
bool CTestboard::SetTrimValues( uint8_t rpc_par1,
                                vector < uint8_t > &rpc_par2 )
{
  RPC_PROFILING bool rpc_par0;
  try {
...
bool CTestboard::LoopMultiRocAllPixelsCalibrate( vector < uint8_t > &rpc_par1,
                                                 uint16_t rpc_par2,
                                                 uint16_t rpc_par3 )
{
  RPC_PROFILING bool rpc_par0;
...
bool CTestboard::LoopMultiRocOnePixelCalibrate( vector < uint8_t > &rpc_par1,
                                                uint8_t rpc_par2,
                                                uint8_t rpc_par3,
                                                uint16_t rpc_par4,
                                                uint16_t rpc_par5 )
...
bool CTestboard::LoopSingleRocAllPixelsCalibrate( uint8_t rpc_par1,
                                                  uint16_t rpc_par2,
                                                  uint16_t rpc_par3 )
{
  RPC_PROFILING bool rpc_par0;
...
bool CTestboard::LoopMultiRocOnePixelDacScan( vector < uint8_t > &rpc_par1,
                                              uint8_t rpc_par2,
                                              uint8_t rpc_par3,
                                              uint16_t rpc_par4,
                                              uint16_t rpc_par5,
...
bool CTestboard::LoopSingleRocOnePixelDacScan( uint8_t rpc_par1,
                                               uint8_t rpc_par2,
                                               uint8_t rpc_par3,
                                               uint16_t rpc_par4,
                                               uint16_t rpc_par5,
...
bool CTestboard::LoopMultiRocAllPixelsDacDacScan( vector < uint8_t >
                                                  &rpc_par1,
                                                  uint16_t rpc_par2,
                                                  uint16_t rpc_par3,
                                                  uint8_t rpc_par4,
...
bool CTestboard::LoopMultiRocOnePixelDacDacScan( vector < uint8_t > &rpc_par1,
                                                 uint8_t rpc_par2,
                                                 uint8_t rpc_par3,
                                                 uint16_t rpc_par4,
                                                 uint16_t rpc_par5,
...
bool CTestboard::LoopSingleRocAllPixelsDacDacScan( uint8_t rpc_par1,
                                                   uint16_t rpc_par2,
                                                   uint16_t rpc_par3,
                                                   uint8_t rpc_par4,
                                                   uint8_t rpc_par5,
...
bool CTestboard::LoopSingleRocOnePixelDacDacScan( uint8_t rpc_par1,
                                                  uint8_t rpc_par2,
                                                  uint8_t rpc_par3,
                                                  uint16_t rpc_par4,
                                                  uint16_t rpc_par5,
...
void CTestboard::VectorTest( vector < uint16_t > &rpc_par1,
