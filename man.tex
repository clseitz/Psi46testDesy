...
to add your git user name. If any changes are made to the .cpp or .h files please use \texttt{make clean} first
to ensure that everything recompiles properly.
