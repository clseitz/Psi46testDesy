...
\item [\texttt{ctl}] set control register (0 = small Vcal,
4 = large Vcal, 1 = ROC off) 
...
efficiency 
\item [\texttt{wtrim\ chip}] write current trim bits to
\texttt{trimParameters\_chip.dat} 
...
\item [\texttt{wdac\ chip}] write current DAC settings to
\texttt{dacParameters\_chip.dat} 
\end{description}
