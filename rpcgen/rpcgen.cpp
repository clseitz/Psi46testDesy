...
int main(int argc, char* argv[])
{
  ...
  try
      ...
      while(true)
	{
	  ...
	  //DP cmdList.push_back( rpcfunct( parser.IsEmptyFnct(), (string)(parser.GetFname() + "$" + parser.GetFparam()) ) );
	  string funcName = parser.GetFname() + '$' + parser.GetFparam(); // DP
	  cmdList.push_back( rpcfunct( parser.IsEmptyFnct(), funcName ) ); // DP
